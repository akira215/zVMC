...
public:
    ...
    /// @brief Level Measurement cluster constructor
    /// @param channel of the ads1115 AD converter for this 
    WaterLevelMeasCluster(uint8_t channel);
...
private:
    ...
    void setLevelMeasuredValue(uint16_t newValue);
